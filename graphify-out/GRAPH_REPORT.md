...
## Corpus Check
- 45 files · ~25,325 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 554 nodes · 1229 edges · 25 communities (20 shown, 5 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 198 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a11f3f48`
...
Cohesion: 0.07
Nodes (67): assignReassignedPorts(), copyReservations(), detectServices(), ensureValidRegistry(), executeLifecycle(), fileExists(), globalScanRoots(), hasConfiguredCollision() (+59 more)
...
Cohesion: 0.07
Nodes (36): File, Listener, Renderer, Style, T, Context, Duration, processState (+28 more)
...
Cohesion: 0.16
Nodes (13): Client, main(), mustGetwd(), Config, Context, processState, ProgressObserver, Manager (+5 more)

### Community 10 - "Runtime Lifecycle Tests"
Cohesion: 0.15
Nodes (26): Config, Listener, Manager, Service, T, Manager, Service, fixtureConfig() (+18 more)
...
Cohesion: 0.21
Nodes (9): TestOutputLogStreamsBeforeInputReachesEOF(), notifyingWriter, T, Context, T, TestRegistryLockHonorsContextWhileContended(), TestRegistryLockReleasesAfterCallbackPanic(), TestRegistryLockSerializesCallbacks() (+1 more)
...
- **Why does `processAlive()` connect `Runtime Process Control` to `Service Lifecycle Manager`, `Runtime Lifecycle Tests`?**
