...
require_in README.md 'go install github.com/phranck/grat/cmd/grat@v1.2.3'
require_in README.md 'grat  v1.2.3'
...
require_in README.md 'expose NAME              Publish the configured path of a service to the internet'
require_in README.md 'hide NAME                Withdraw a published path'
