...
require_in README.md 'go install github.com/phranck/grat/cmd/grat@v1.3.2'
require_in README.md 'grat  v1.3.2'
require_in README.md '`grat update` shows an animated spinner in an interactive terminal.'
require_in README.md 'Redirected or color-disabled output receives an immediate static working step'
require_in README.md '`grat.config`'
require_in README.md '`.grat/`'
require_in README.md 'expose [--path P] NAME     Publish a service to the internet; --path narrows it to one path'
require_in README.md 'hide [--path P] NAME       Withdraw a published service or path'
require_in README.md '[services.expose]'
require_in README.md 'public_port'
